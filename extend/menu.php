...
<nav class="green">
    ...
    <ul class="side-nav" id="mobile-demo">
            ...
            <li><a href='../inicio/panel.php' data-activates='config'>PANEL</a></li>
            <li><a href='../inicio' data-activates='config'>PROSPECTO</a></li>
...
<li><a class="black-text" href="../inicio/panel.php"><button class="btn btn-floating green"><i class="material-icons">home</i></button> PANEL</a></li>

<li><a class="black-text" href="../inicio"><button class="btn btn-floating green"><i class="material-icons">account_circle</i></button> PROSPECTO</a></li>
...
<li><a class='dropdown-button black-text' href='#' data-activates='configuracion'><button class="btn btn-floating green"><i class="material-icons">settings</i></button> CONFIGURACION</a></li>
